...
class UniAppStateRestorationTest {
    ...
    fun compactDevice_selectedEmailEmailRetained_afterConfigChange() {
        ...
        stateRestorationTester.setContent { UniApp(windowSize = WindowWidthSizeClass.Compact) }
    ...
    fun expandedDevice_selectedEmailEmailRetained_afterConfigChange() {
        ...
        val stateRestorationTester = StateRestorationTester(composeTestRule)
        stateRestorationTester.setContent { UniApp(windowSize = WindowWidthSizeClass.Expanded) }
